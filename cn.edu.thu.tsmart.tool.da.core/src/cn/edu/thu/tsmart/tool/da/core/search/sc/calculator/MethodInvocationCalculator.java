...
public class MethodInvocationCalculator {
	public static double sim(MethodInvocation e1, Expression e2) {
	...
	public static double sim(MethodInvocation e1, MethodInvocation e2) {
		...
		double argumentSizeSimilarity = U.intSim(e1.arguments().size(), e2
				.arguments().size());
		return U.mean(objectNameSimilarity, methodNameSimilarity,
				argumentSizeSimilarity);
	}
}
