...
public class AssignmentCalculator {
	public static double sim(Assignment e1, Expression e2){
...
//        }
	...
	public static double sim(Assignment e1, Assignment e2){
		double lSim=U.stringSim(e1.getLeftHandSide().toString(), e2.getLeftHandSide().toString());
		double opSim=e1.getOperator().equals(e2.getOperator())?1:0.5;
		double rSim=SimilarityCalculator.sim(e1.getLeftHandSide(), e2.getRightHandSide());
		return U.mean(lSim,opSim,rSim);
	}
}
