...
public class InstanceofExpressionCalculator {
	public static double sim(InstanceofExpression e1, Expression e2) {
		...
		// }
		// else
		if (e2 instanceof InstanceofExpression) {
	...
	public static double sim(InstanceofExpression e1, InstanceofExpression e2) {
		double typeSimilarity = U.stringSim(e1.getRightOperand().toString(), e2
