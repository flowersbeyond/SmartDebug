...
public class ArrayInitializerCalculator {
	public static double sim(ArrayInitializer e1, Expression e2) {
	...
	public static double sim(ArrayInitializer e1, ArrayInitializer e2) {
		double sizeSimilarity = U.intSim(e1.expressions().size(),
				((ArrayInitializer) e2).expressions().size());
