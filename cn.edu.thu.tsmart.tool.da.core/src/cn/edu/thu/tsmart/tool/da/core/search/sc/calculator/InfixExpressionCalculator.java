...
public class InfixExpressionCalculator {
	public static double sim(InfixExpression e1, Expression e2) {
	...
	public static double sim(InfixExpression e1, InfixExpression e2) {
		Operator op1 = e1.getOperator();
		Operator op2 = e2.getOperator();
		if (U.canInfixOpReturnBoolean(op1) && U.canInfixOpReturnBoolean(op2)) {
			return 1;
		} else if (U.canInfixOpReturnNumber(op1)
				&& U.canInfixOpReturnNumber(op2)) {
			return 1;
		} else {
			return 0;
		}
