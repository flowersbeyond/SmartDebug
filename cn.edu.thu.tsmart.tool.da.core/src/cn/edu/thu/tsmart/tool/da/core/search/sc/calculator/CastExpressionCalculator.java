...
public class CastExpressionCalculator {
	public static double sim(CastExpression e1, Expression e2){
...
//        }
//        else 
        	if(e2 instanceof CastExpression){
//            return sim(e1,(CastExpression)e2);
        		return SimilarityCalculator.sim(e1.getExpression(), ((CastExpression) e2).getExpression());
        }
