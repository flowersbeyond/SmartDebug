...
public class SuperFieldAccessCalculator {
	public static double sim(SuperFieldAccess e1, Expression e2){
...
//        }
	...
	public static double sim(SuperFieldAccess e1, SuperFieldAccess e2){
        return U.stringSim(e1.getName().toString(), e2.getName().toString());
    }
}
