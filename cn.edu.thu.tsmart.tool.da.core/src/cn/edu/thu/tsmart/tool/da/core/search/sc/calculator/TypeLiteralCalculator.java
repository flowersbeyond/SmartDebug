...
public class TypeLiteralCalculator {
	public static double sim(TypeLiteral e1, Expression e2){
...
//        }
	...
	public static double sim(TypeLiteral e1, TypeLiteral e2){
        return U.stringSim(e1.getType().toString(), e2.getType().toString());
    }
}
