...
public class PostfixExpressionCalculator {
	public static double sim(PostfixExpression e1, Expression e2){
...
//        }
//        else
        	if(e2 instanceof PostfixExpression){
...
//        }
	...
	public static double sim(PostfixExpression e1, PostfixExpression e2){
		double numberSimilarity=U.doubleSim(Double.parseDouble(e1.getOperand().toString()), Double.parseDouble(e2.getOperand().toString()));
